...
不过纵观自己的产品文档，也有不少缺陷：比如对于视障人士的了解不够深入，未能很好的剖析产品的价值主张，其次在代码的测试上仍有很大的进步空间，去尝试输入更多的数据并分析其结果，使平台API对比更加全面等。本学期对于API、人工智能与机器学习这门课程自我总结收获不少，对于未来的产品开发和设计逻辑的帮助上有莫大的意义与经验积累，感谢帮助过我的老师与同学，希望今后能保持积极向上的心态，继续努力！
<br/>
